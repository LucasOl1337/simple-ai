...
Elas têm orgulho do que fazem. Elas SABEM o trabalho delas melhor do que ninguém. A conversa é por texto — escreva como gente fala.
...
def build_messages(
    ...
    Args:
        ...
        user_message: The new user utterance (typed text message).
